...
export default function InstructorSidebar({ userName, userEmail, signOutAction }: Props) {
    ...
    <aside className="w-52 shrink-0 flex flex-col h-full" style={{ background: 'var(--sidebar)', borderRight: '1px solid rgba(255,255,255,0.06)' }}>
      ...
      <div className="px-4 py-4 flex items-center gap-2.5" style={{ borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
        ...
        <div>
          ...
          <p className="text-[10px] leading-tight" style={{ color: 'rgba(255,255,255,0.3)' }}>Instructor</p>
        </div>
      </div>
        ...
        {NAV.map((item) => {
          ...
          return (
            <Link
              ...
              style={active ? { background: 'rgba(255,255,255,0.1)', color: 'rgba(255,255,255,0.95)' } : {}}
            >
